...
public class RobinHoodMapGetHitTest {
	...
	private RobinHoodMap<String, String> robinHoodMap;
...
//	@Benchmark
	public void get() {
		...
		RobinHoodMap<String, String> localRobinHoodMap = this.robinHoodMap;
		for (int i = 0; i < localSize; i++) {
			if (localRobinHoodMap.get(localElements[i]) == null) {
