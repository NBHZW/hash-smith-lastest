...
public class EclipseCollectionsUnifiedMapGetHitTest {
	...
	private UnifiedMap<String, String> unifiedMap;
...
//	@Benchmark
	public void get() {
		...
		UnifiedMap<String, String> localUnifiedMap = this.unifiedMap;
		for (int i = 0; i < localSize; i++) {
			if (localUnifiedMap.get(localElements[i]) == null) {
